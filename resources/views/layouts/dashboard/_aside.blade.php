    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            @if (auth()->user()->hasPermission('read_tickets'))
                <li><a href="{{ route('dashboard.tickets.index') }}"><i class="fa fa-th"></i><span>@lang('site.tickets')</span></a></li>
            @endif
            ...
            {{--<li><a href="{{ route('dashboard.tickets.index') }}"><i class="fa fa-book"></i><span>@lang('site.tickets')</span></a></li>--}}
            {{----}}
            {{----}}
